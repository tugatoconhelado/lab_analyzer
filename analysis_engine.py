...
from data_loader import Hdf5Loader
...
class AnalysisEngine:
    ...
    def get_data(self, path):
        ...
        return self.loader.fetch_dataset(path)
    ...
    def run_fit(self):
        ...
        self.fit_x = self.fit_result.userkws['x']
...
if __name__ == "__main__":
    ...
    engine = AnalysisEngine("C:\EXP\python\lab_analyzer\models")
    engine.load_file(r"ex_data.h5")
    #x_data, y_data = engine.select_data("tau", "pl_mean")
    ...
    engine.load_fit("ex_data.h5")
    
    #engine.save_fit(r"ex_data.h5")

    fig, ax = plt.subplots()
    ax.plot(engine.active_x, engine.active_y, "bo")
    ax.plot(engine.fit_x, engine.fit_y, "r-")
